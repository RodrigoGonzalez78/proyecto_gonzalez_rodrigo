...
<div id="hero-carousel" class="carousel slide" data-bs-ride="carousel">
	...
	<div class="carousel-inner">
		...
		<div class="carousel-item active">
			<img src="assets/img/pc.png" class="d-block w-100" height="500px" alt="Slide 1">
			<div class="carousel-caption top-0 mt-4">
				...
				<button class="btn my-btn-primary px-4 py-2 fs-5 mt-2 fw-bold">Book a tour</button>
			</div>
		</div>
		...
		<div class="carousel-item">
			...
			<div class="carousel-caption top-0 mt-4  ">
				...
				<button class="btn my-btn-primary px-4 py-2 fs-5 mt-2 fw-bold" data-bs-toggle="modal" data-bs-target="#booking-modal">Book a tour</button>
			</div>
		</div>
