<div id="about" class="container py-4">
  ...
  <div class="row featurette my-3">
    <div class="col-md-7">
      <h2 class="featurette-heading fw-bold lh-1">Calidad y el servicio al cliente. <span class=" my-text-color">Nuestra misión.</span></h2>
      <p class="lead ">Desde nuestros humildes comienzos hace más de 20 años, hemos trabajado arduamente para ofrecer a nuestros clientes una amplia gama de productos de hardware de alta calidad, desde tarjetas de video y procesadores hasta discos duros y monitores. Gracias a nuestro compromiso inquebrantable con la calidad y el servicio al cliente, nos hemos convertido en uno de los principales proveedores de equipos y componentes en la región. Nuestro equipo dedicado y experimentado trabaja incansablemente para garantizar que todos nuestros clientes reciban una experiencia excepcional, desde la compra hasta la entrega y más allá.</p>
    </div>
    <div class="col-md-5">
